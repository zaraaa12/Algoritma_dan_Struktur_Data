...
public class Perbaikanuts {
    public static void main(String[] args) {
        ...
        input.add(new Mahasiswa("Angeli", "Civic Education", 4, 88));
        input.add(new Mahasiswa("Zaraa", "Bahasa Inggris", 2, 90));
        input.add(new Mahasiswa("Donny", "Ekonomi Mikro", 2, 84));
        input.add(new Mahasiswa("Emmy", "Pemrograman", 4, 92));
        input.add(new Mahasiswa("Queen", "Teologi Aswaja", 3, 98));
